...
ActiveRecord::Schema.define(version: 20180429150558) do
  ...
  create_table "company_owners", force: :cascade do |t|
    ...
    t.index ["invitation_token"], name: "index_company_owners_on_invitation_token", unique: true
    t.index ["invitations_count"], name: "index_company_owners_on_invitations_count"
    t.index ["invited_by_id"], name: "index_company_owners_on_invited_by_id"
    t.index ["invited_by_type", "invited_by_id"], name: "index_company_owners_on_invited_by_type_and_invited_by_id"
